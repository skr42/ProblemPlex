...
from stackbase.models import Question, Comment
...
@login_required
def user_questions_list(request):
    user_questions = Question.objects.filter(user=request.user)  # Adjust 'author' to match your field name
...
def logout_view(request):
    if request.user.is_authenticated:
        ...
        username = "Guest"  # Default message if user was not authenticated
    return render(request, 'stackusers/logout.html', {'username': username})